...
public class SQLiteConnectionManager {
    ...
    public void addValidWord(int id, String word) {
        ...
        try (Connection conn = DriverManager.getConnection(databaseURL);
            ...
            pstmt.executeUpdate();
            logger.fine("Added valid word to DB: " + word);
        } catch (SQLException e) {
            logger.log(Level.WARNING, "Failed to insert word into validWords: " + word, e);
        }
    }
    ...
    public boolean isValidWord(String guess) {
        ...
        try (Connection conn = DriverManager.getConnection(databaseURL);
            ...
            logger.log(Level.WARNING, "Failed to check if word is valid: " + guess, e);
            return false;
        }
    }
}
